    ...
    <>
      <div className="flex flex-col justify-around border drop-shadow-md m-2 p-5 w-full min-h-40 h-fit bg-neutral-50">
        ...
        <button
          ...
          className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 my-2 "
        >
          Submit
        </button>
      </div>
